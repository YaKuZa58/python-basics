...
first_name = 'Corey'
last_name = 'Nakagawa'
birth_place = 'Wahiawa, Hawaii'
hobby = 'Gaming, POGO, and Gunpla'
role_model = 'Venom/Eddie Brock'
famous_quote = 'You are Brock. I am symbiote. WE ARE VENOM!'
fav_president = 'Barack Obama'
fav_food = 'Japanese Food and Beef Stew'
fav_color = 'Orange and Blue'
fav_song = 'Numb - Linkin Park'
...
about_me = 'My hobbies are ' + hobby + ', my favorite song is ' + fav_song + ', and I like to eat ' + fav_food + '.'
print(about_me)
...
fav_number = 58
yen_rate = 110.97
bitcoin_value = 6325.01
todays_temperature = 82
hawaii_population = 1428000
...
about_hawaii = "Did you know that Hawaii's population is " + str(hawaii_population) + 'and the average temperature is ' + str(todays_temperature) + '?'
print(about_hawaii)
...
fab_five = ["Lay's Wavy Chip's", "Funyuns Chip's", 'Chips Ahoy!', "Reese's Peanut Butter Cups", 'Twix']
print(fab_five)
...
plate_lunch = ['Chicken Katsu', 'Kalbi', 'Meat Jun', 'Spam', 'Fish']
print(plate_lunch)
...
ice_cream = ['Cookie Dough', 'Mint Chip', 'French Vanilla']
print(ice_cream)
...
hamajang = ['Sushi', 22, ['Poke', 'Sashimi'], {'Name': 'Jolie', 'Age': 30}, ('Birds', 'Dogs', 'Cats')]
print(hamajang)
...
dynamic_duos = [['Peanut Butter', 'Jelly'], ['Batman', 'Robin'], ['Chips', 'Dip']]
print(dynamic_duos)
...
footwear = {
    'Brand': 'Vivo Barefoot',
    'URL': 'http://www.vivobarefoot.com/us',
    'Gender': 'Mens',
    'Type': 'Ababa Canvas',
    'Price': 80,
...
bank = {
    ...
    'Revenue': 700000000,
    'NASDAQ': 'FHB',
    'Production': ['Savings', 'Loans', 'Trust', 'Wealth Management'],
...
pandas['Highest Revenue'] = 'Ala Moana Center Food Court'
...
bucket_list = {}
bucket_list['Travel'] = 'Japan'
bucket_list['Learn'] = 'Japanese'
bucket_list['Weight'] = 135
bucket_list['To Do'] = ['Explore all of Japan', 'Try food from all over Japan', 'Drive Hakone']
bucket_list['Meet Person'] = 'JDF = Jason David Frank'
